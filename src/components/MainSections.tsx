...
const EVENTS = [
  {
    date: "11 июля",
    weekday: "Пятница",
    title: "Собрание книжного клуба «Тайтл»",
    desc: "В день рождения Кентаро Миуры, создателя манги «Берсерк», проводим очередную встречу клуба. 📚",
    place: "Библиотека, Кулиева, 6 🏛️",
  },
];
